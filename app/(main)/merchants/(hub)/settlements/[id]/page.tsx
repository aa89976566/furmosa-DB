        ...
        <SectionCard title="結算摘要" className="lg:col-span-1">
          <dl className="space-y-2 text-sm">
            ...
            <Row
              label="店家"
              value={
                <Link href={`/merchants/${settlement.merchant.id}`} className="hover:underline">
            ...
            <Row label="實際抽成率" value={formatPercent(Number(settlement.commissionRate), 1)} />
            ...
            />
            <Row label="狀態" value={<StatusBadge kind="settlement" value={settlement.status} />} />
            {settlement.paidAt ? (
