...
export const JAR_MENU_LEAVE_RE =
  /^(?:什麼是換罐計劃？|什麼是換罐計劃|介紹|流程|毛爸媽常問|常見問題|Q&A|QA|幫毛孩開戶|立即開戶|開戶|開始換罐|輸入序號|輸入空罐序號|兌換序號|點數換折價|換成美容折價|兌換優惠券|兌換優惠卷|兌換美容折價券|看本期口味|本期口味|查看合作店|查看合作店家|合作店家|配合店家|兌換好禮|兌換好康|換罐計劃是什麼|線上預購換罐|我要換罐|了解更多|查看點數)$/i;
