import { REFILL_REWARD_POINTS as REFILL_POINTS } from '@/lib/coupons/store-discount';
...
export const GROOMING_COUPON_TYPE = 'grooming_200';
export const GROOMING_COUPON_POINTS = REFILL_POINTS;
/** @deprecated 請改用 getGroomingCouponDiscountForStore；豬窩 250、其他 200 */
export const GROOMING_COUPON_DISCOUNT = 200;
