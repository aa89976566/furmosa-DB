    ...
    <div className="space-y-6">
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <HeroKpi
          ...
          description="本週序號返航 · 點進營運台看庫存與補貨"
          icon={Recycle}
          accent="primary"
      ...
      <div className="grid gap-8 rounded-2xl border border-border/50 bg-surface-raised/50 p-5 shadow-card md:p-6 lg:grid-cols-3">
        ...
        <KpiGroup title="換罐計畫" description="營運狀態 · 點進營運台補貨">
          <MetricKpi
            ...
            description={`缺貨 ${formatNumber(kpis.jarOutOfStockCellCount)} 格 · 換罐店×商品`}
            icon={AlertTriangle}
            accent={kpis.jarOutOfStockCellCount > 0 ? 'destructive' : 'warning'}
            href="/jar-exchange/ops"
          />
          <MetricKpi
            title="在途補貨"
