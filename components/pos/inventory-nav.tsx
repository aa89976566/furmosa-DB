  ...
  return (
    <aside className="hidden h-full w-[220px] shrink-0 flex-col border-r border-neutral-200 bg-white md:flex">
      <div className="px-5 pb-6 pt-6">
        <p className="text-lg font-semibold tracking-[0.18em] text-zinc-900">
          FURMOSA
        </p>
        <p className="text-sm font-medium text-zinc-900">匠寵</p>
        <p className="mt-0.5 text-xs tracking-[0.14em] text-zinc-400">
          STORE POS
        </p>
      </div>
...
export function InventoryBottomNav() {
  ...
  return (
    <nav
      className="fixed inset-x-0 bottom-0 z-40 border-t-2 border-neutral-900 bg-white md:hidden"
      aria-label="店家導航"
    >
