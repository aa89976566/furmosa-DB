# Phase 1：MerchantUser（已實作）

> **狀態：** implemented（2026-07-21）— 見 `docs/PLAN-pos-booking-system.md` §10  
> **日期：** 2026-07-21  
> **依據：** `docs/FURMOSA-OS-DOMAIN-SPEC-v1.md` v1.1（FD-11）+ 產品確認  
> **本文件保留為設計原案；執行細節以 PLAN §10 為準。**
