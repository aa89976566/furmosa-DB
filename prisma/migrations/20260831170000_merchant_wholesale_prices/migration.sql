-- CreateTable
CREATE TABLE "MerchantWholesalePrice" (
    "id" TEXT NOT NULL,
...
CREATE UNIQUE INDEX "MerchantWholesalePrice_merchantId_productId_variantKey_key"
ON "MerchantWholesalePrice"("merchantId", "productId", "variantKey");

CREATE INDEX "MerchantWholesalePrice_merchantId_idx"
ON "MerchantWholesalePrice"("merchantId");

CREATE INDEX "MerchantWholesalePrice_productId_idx"
